...
# ansible-playbook /tmp/setup-scripts/network-lab-1/solution_challenge_3.yml
...
sudo chown rhel:rhel /home/rhel/solve_challenege_3.yml

su - rhel -c 'ansible-playbook /home/rhel/solve_challenege_3.yml'